...
public class App {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            int firstNum = scanner.nextInt(); // 데이터 입력 받기

            // 두 번째 양의 정수(0포함) 입력받기
            System.out.print("두 번째 숫자를 입력하세요: ");
            int secondNum = scanner.nextInt(); // 데이터 입력 받기
            scanner.nextLine(); // 버퍼 소비해주기 nextInt은 개행문자를 소비하지 않는다.

            // 사칙연산 기호 입력받기
            System.out.print("사칙연산 기호를 입력하세요: ");
            String mathSymbol = scanner.nextLine(); // 데이터 입력 받기
            ...
            System.out.println("계산 종료: 'exist'입력, 계산을 처음부터 하시려면 엔터를 입력하세요.");
